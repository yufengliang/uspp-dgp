c
c Copyright (C) 2006 Vanderbilt group
...
c
cccc gfortran has this as intrinsic
cccc      external idate
c
c=======================================================================
...
c
c=======================================================================
c     c h a n g e s  f o r  c h a n g e o v e r  t o  uspp-733
c=======================================================================
c
...
c
c=======================================================================
c     c h a n g e s  m a d e  t o  c r e a t e  uspp-734
c=======================================================================
c
c    [46] Fixed minor bug in subroutines schsol, dirsol and koesol as
c         reported by G. Balducci and B. Meyer.  See details in
c         subroutine dirsol.  Only affects behavior when convergence
c         fails to occur in the allowed number of iterations.
c
c    [47] Fix minor bug in pswfnormc as reported by Asbjorn Christensen
c         (innocuous divide-by-zero errors when constructing
c         norm-conserving pseudo-wavefunctions).
c
c    [48] Fixed bug in reform.f in /Utils reported by Martin Konopka.
c         The bug was in a purely cosmetic part of the code that had
c         no actual consequences.
c
c    [49] Cosmetic changes in ifprt behavior and format of *.out files
c         -- ifprt.ge.2 triggers printout of plot of diagonal q-funcs
c         -- more rational print control for pseudo test runs
c         -- total energy reported for pseudo test runs (B. Meyer)
c         -- better support for fractional atomic numbers (B. Meyer)
c         -- eigenvalues of transformed q-matrix are now printed and
c              warnings are issued if some are unreasonably large
c
c=======================================================================
c     c h a n g e s  m a d e  t o  c r e a t e  uspp-735
c=======================================================================
c
c    [50] This version is exactly identical to uspp-734 except
c         for insertion of some comment lines in runatom.f and
c         scgsubs.f to facilitate interoperability with the
c         "USpp2Abinit" module of the ABINIT software project.
c
c=======================================================================
c     c h a n g e s  m a d e  t o  c r e a t e  uspp-736
c=======================================================================
c
c    [51] This version is exactly identical to uspp-735 except
c         for insertion of additional comment lines in runatom.f
c         and scgsubs.f to facilitate continued interoperability with
c         newer versions of "USpp2Abinit", and two minor bug fixes in
c         pssubs.f.
c
c=======================================================================
...
c
        write(stderr,*) 'begin pseudopotential test'
        write(iout,'(/1x,a)')
     +     'begin self-consistent cycle for pseudopotential test'
c
...
c         progress report
 ...
 9989     format('completed self-consistent cycle',i4,' delta =',d15.7)
          if (ifprt.gt.0) write (iout,*)
          write (iout,'(a,i4,a,d15.7)')
     +      ' end self-consistent cycle',iter,' delta =',delta
c
c         check whether self-consistency has been achieved
...
c       compute total energy
        etotps = 0.0d0
        do i = ncores+1,ncspvs
           etotps = etotps + wwnl(i) * ee(i)
        enddo
        etotps = etotps - ehar + emvxc
        write(6,'(/a,f14.7)') ' total energy =', etotps
c
...
c -- Insert here call to uspp2abinit (1)
...
c -- Insert here call to uspp2abinit (3)
...
c -- Insert here call to uspp2abinit (2)
